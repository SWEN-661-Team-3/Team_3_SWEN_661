...
const styles = StyleSheet.create({
  ...
  groupTitle: { fontSize: 16, fontWeight: '700', letterSpacing: 2, color: Colors.mutedText, marginBottom: 12, textTransform: 'uppercase' },
  planItem: { flexDirection: 'row', alignItems: 'flex-start', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: Colors.border, flexWrap: 'wrap' },
  ...
  timeBadgeText: { fontSize: 16, fontWeight: '700', color: Colors.primaryAction },
  ...
  actionBadgeText: { fontSize: 16, fontWeight: '700', color: Colors.primaryAction },
  ...
  progressRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8, flexWrap: 'wrap' },
  progressText: { fontSize: 16, fontWeight: '700', color: Colors.heading, flexShrink: 1 },
